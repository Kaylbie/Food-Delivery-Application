...
namespace Baigiamasisdarbas {
	...
	/// <summary>
	/// Summary for ViewOrder
	/// </summary>
	public ref class ViewOrder : public System::Windows::Forms::Form
	{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(ViewOrder::typeid));
			...
			this->UserText = (gcnew System::Windows::Forms::Label());
			...
			this->RegPanel->Controls->Add(this->UserText);
			...
			this->RegPanel->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &ViewOrder::RegPanel_Paint);
			// 
			// label4
			// 
			...
			this->label4->Location = System::Drawing::Point(537, 198);
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"Arial", 15, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label3->Location = System::Drawing::Point(443, 198);
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Arial", 15, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label2->Location = System::Drawing::Point(320, 198);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(106, 24);
			this->label2->TabIndex = 38;
			this->label2->Text = L"Patiekalas";
			// 
			// Status
			// 
			...
			this->Status->Font = (gcnew System::Drawing::Font(L"Arial", 15, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->Status->Location = System::Drawing::Point(317, 384);
			...
			this->OrderGrid->BackgroundColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(236)), static_cast<System::Int32>(static_cast<System::Byte>(222)),
				static_cast<System::Int32>(static_cast<System::Byte>(195)));
			...
			this->OrderGrid->Location = System::Drawing::Point(321, 225);
			...
			this->OrderGrid->Size = System::Drawing::Size(417, 146);
			this->OrderGrid->TabIndex = 36;
			// 
			// UserText
			// 
			this->UserText->AutoSize = true;
			this->UserText->Font = (gcnew System::Drawing::Font(L"Arial", 15, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->UserText->Location = System::Drawing::Point(317, 151);
			this->UserText->Name = L"UserText";
			this->UserText->Size = System::Drawing::Size(82, 24);
			this->UserText->TabIndex = 34;
			this->UserText->Text = L"\?\?\?\?\?\?";
			// 
			// OrderId
			// 
			...
			this->OrderId->Font = (gcnew System::Drawing::Font(L"Arial", 15, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->OrderId->Location = System::Drawing::Point(317, 93);
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Arial", 15, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label1->Location = System::Drawing::Point(171, 384);
			...
			this->label11->Font = (gcnew System::Drawing::Font(L"Arial", 15, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label11->Location = System::Drawing::Point(134, 93);
			...
			this->RegCancel->Font = (gcnew System::Drawing::Font(L"Arial", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->RegCancel->Location = System::Drawing::Point(321, 449);
			...
			this->RegCancel->Click += gcnew System::EventHandler(this, &ViewOrder::RegCancel_Click);
			// 
			// label9
			// 
			...
			this->label9->Font = (gcnew System::Drawing::Font(L"Arial", 15, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label9->Location = System::Drawing::Point(158, 151);
			this->label9->Name = L"label9";
			this->label9->Size = System::Drawing::Size(106, 24);
			this->label9->TabIndex = 17;
			this->label9->Text = L"Vartotojas";
			// 
			// label6
			// 
			...
			this->label6->Font = (gcnew System::Drawing::Font(L"Arial", 15, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label6->Location = System::Drawing::Point(166, 225);
			...
			this->label8->Font = (gcnew System::Drawing::Font(L"Arial", 25, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label8->Location = System::Drawing::Point(289, 14);
			...
			this->label7->Font = (gcnew System::Drawing::Font(L"Arial", 15, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label7->Location = System::Drawing::Point(639, 198);
			this->label7->Name = L"label7";
			this->label7->Size = System::Drawing::Size(63, 24);
			this->label7->TabIndex = 41;
			this->label7->Text = L"Suma";
			// 
			// ViewOrder
			// 
