...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Location = System::Drawing::Point(617, 47);
			...
			// RegUserNameBox
			// 
			this->RegUserNameBox->Location = System::Drawing::Point(333, 139);
			...
			this->label11->Font = (gcnew System::Drawing::Font(L"Arial", 15, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label11->Location = System::Drawing::Point(97, 135);
			...
			this->RegCancel->Font = (gcnew System::Drawing::Font(L"Arial", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->RegCancel->Location = System::Drawing::Point(219, 441);
			...
			this->RegCancel->Click += gcnew System::EventHandler(this, &EditClient::RegCancel_Click);
			// 
			// RegRegisterButton
			// 
			...
			this->RegRegisterButton->Click += gcnew System::EventHandler(this, &EditClient::RegRegisterButton_Click);
			// 
			// RegAdressBox
			// 
			this->RegAdressBox->Location = System::Drawing::Point(333, 301);
			...
			// RegPasswordBox
			// 
			this->RegPasswordBox->Location = System::Drawing::Point(333, 356);
			...
			this->label10->Font = (gcnew System::Drawing::Font(L"Arial", 15, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label10->Location = System::Drawing::Point(176, 297);
			...
			this->label9->Font = (gcnew System::Drawing::Font(L"Arial", 15, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label9->Location = System::Drawing::Point(174, 243);
			...
			// RegSurnameBox
			// 
			this->RegSurnameBox->Location = System::Drawing::Point(333, 247);
			...
			// RegNameBox
			// 
			this->RegNameBox->Location = System::Drawing::Point(333, 193);
			...
			this->label6->Font = (gcnew System::Drawing::Font(L"Arial", 15, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label6->Location = System::Drawing::Point(186, 189);
			...
			this->label7->Font = (gcnew System::Drawing::Font(L"Arial", 15, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label7->Location = System::Drawing::Point(142, 351);
			...
			this->label8->Font = (gcnew System::Drawing::Font(L"Arial", 25, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label8->Location = System::Drawing::Point(261, 43);
			this->label8->Name = L"label8";
			this->label8->Size = System::Drawing::Size(350, 40);
			this->label8->TabIndex = 12;
			this->label8->Text = L"Kliento redagavimas";
			// 
			// label5
			// 
			...
			this->ClientSize = System::Drawing::Size(816, 557);
