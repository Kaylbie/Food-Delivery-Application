...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->RegCancel->Click += gcnew System::EventHandler(this, &AddDish::RegCancel_Click);
			// 
			// RegRegisterButton
			// 
			...
			this->RegRegisterButton->Click += gcnew System::EventHandler(this, &AddDish::RegRegisterButton_Click);
			// 
			// label9
			// 
			...
			this->PriceBox->Size = System::Drawing::Size(45, 20);
			...
			this->label8->Size = System::Drawing::Size(347, 40);
			this->label8->TabIndex = 12;
			this->label8->Text = L"Patiekalo pridėjimas";
			// 
			// label5
			// 
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Arial", 15, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label2->Location = System::Drawing::Point(380, 193);
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"Arial", 8, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label3->Location = System::Drawing::Point(407, 198);
